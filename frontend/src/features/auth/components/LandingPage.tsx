      ...
      <header className="relative z-50 py-6">
        <div className="container mx-auto px-6 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-4">
            ...
            <Button onClick={handleGoogleLogin} className="bg-black dark:bg-white text-white dark:text-black hover:bg-black/80 dark:hover:bg-white/90 rounded-full shadow-lg font-bold px-6 flex items-center gap-2">
        ...
        <div className="container mx-auto px-6 relative">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-6">
              <Button
                size="lg"
                className="w-full sm:w-auto h-16 px-10 text-xl font-bold bg-[#FF4500] hover:bg-[#FF4500]/90 text-white rounded-full shadow-[0_8px_0_rgb(200,50,0)] hover:shadow-[0_4px_0_rgb(200,50,0)] hover:translate-y-1 transition-all gap-3 flex items-center justify-center"
